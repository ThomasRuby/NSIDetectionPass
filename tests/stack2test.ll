...
define void @permut(%struct.node* %head, i32 %i, i32 %j) #2 {
entry:
  %cmp = icmp eq i32 %i, %j
...
; Function Attrs: nounwind uwtable
define %struct.node* @visit(%struct.node* nocapture readonly %head, i32* nocapture %element) #2 {
entry:
...
; Function Attrs: nounwind uwtable
define %struct.node* @partition(%struct.node* %head) #2 {
entry:
...
; Function Attrs: nounwind uwtable
define %struct.node* @reverse_malloc(%struct.node* %head) #2 {
entry:
...
; Function Attrs: nounwind uwtable
define %struct.node* @concat(%struct.node* %head1, %struct.node* %head2) #2 {
entry:
...
; Function Attrs: nounwind uwtable
define %struct.node* @pop(%struct.node* nocapture %head, i32* nocapture %element) #2 {
entry:
  %data = getelementptr inbounds %struct.node* %head, i64 0, i32 0
  %0 = load i32* %data, align 4, !tbaa !7
  store i32 %0, i32* %element, align 4, !tbaa !8
...
; Function Attrs: nounwind uwtable
define noalias %struct.node* @push(%struct.node* %head, i32 %data) #2 {
entry:
...
; Function Attrs: nounwind uwtable
define %struct.node* @quicksort(%struct.node* %head) #2 {
entry:
...
; Function Attrs: nounwind readnone uwtable
define i32 @empty(%struct.node* readnone %head) #0 {
entry:
...
; Function Attrs: nounwind uwtable
define noalias %struct.node* @insert_rec(%struct.node* %head, i32 %data) #2 {
entry:
  %cmp.i = icmp eq %struct.node* %head, null
...
if.then:                                          ; preds = %entry
  %call.i = tail call noalias i8* @malloc(i64 16) #5
  %cmp.i14 = icmp eq i8* %call.i, null
  br i1 %cmp.i14, label %if.then.i, label %push.exit
...
push.exit:                                        ; preds = %if.then
  ...
  %0 = bitcast i8* %next.i to %struct.node**
  store %struct.node* null, %struct.node** %0, align 8, !tbaa !1
  br label %return

if.else:                                          ; preds = %entry
  %data.i = getelementptr inbounds %struct.node* %head, i64 0, i32 0
  %1 = load i32* %data.i, align 4, !tbaa !7
  %next.i15 = getelementptr inbounds %struct.node* %head, i64 0, i32 1
  %2 = load %struct.node** %next.i15, align 8, !tbaa !1
  %3 = bitcast %struct.node* %head to i8*
  tail call void @free(i8* %3) #5
  %cmp = icmp slt i32 %1, %data
  br i1 %cmp, label %if.then3, label %if.else6

if.then3:                                         ; preds = %if.else
  %call4 = tail call %struct.node* @insert_rec(%struct.node* %2, i32 %data)
  %call.i22 = tail call noalias i8* @malloc(i64 16) #5
  %cmp.i23 = icmp eq i8* %call.i22, null
  br i1 %cmp.i23, label %if.then.i24, label %push.exit27

if.then.i24:                                      ; preds = %if.then3
  tail call void @exit(i32 0) #6
  unreachable

push.exit27:                                      ; preds = %if.then3
  %data1.i25 = bitcast i8* %call.i22 to i32*
  store i32 %1, i32* %data1.i25, align 4, !tbaa !7
  %next.i26 = getelementptr inbounds i8* %call.i22, i64 8
  %4 = bitcast i8* %next.i26 to %struct.node**
  store %struct.node* %call4, %struct.node** %4, align 8, !tbaa !1
  br label %return

if.else6:                                         ; preds = %if.else
  %call.i28 = tail call noalias i8* @malloc(i64 16) #5
  %cmp.i29 = icmp eq i8* %call.i28, null
  br i1 %cmp.i29, label %if.then.i30, label %push.exit33

if.then.i30:                                      ; preds = %if.else6
  tail call void @exit(i32 0) #6
  unreachable

push.exit33:                                      ; preds = %if.else6
  %data1.i31 = bitcast i8* %call.i28 to i32*
  store i32 %1, i32* %data1.i31, align 4, !tbaa !7
  %next.i32 = getelementptr inbounds i8* %call.i28, i64 8
  %5 = bitcast i8* %next.i32 to %struct.node**
  store %struct.node* %2, %struct.node** %5, align 8, !tbaa !1
  %call.i16 = tail call noalias i8* @malloc(i64 16) #5
  %cmp.i17 = icmp eq i8* %call.i16, null
  br i1 %cmp.i17, label %if.then.i18, label %push.exit21

if.then.i18:                                      ; preds = %push.exit33
  tail call void @exit(i32 0) #6
  unreachable

push.exit21:                                      ; preds = %push.exit33
  %data1.i19 = bitcast i8* %call.i16 to i32*
  store i32 %data, i32* %data1.i19, align 4, !tbaa !7
  %next.i20 = getelementptr inbounds i8* %call.i16, i64 8
  %6 = bitcast i8* %next.i20 to i8**
  store i8* %call.i28, i8** %6, align 8, !tbaa !1
  br label %return

return:                                           ; preds = %push.exit21, %push.exit27, %push.exit
  %retval.0.in = phi i8* [ %call.i, %push.exit ], [ %call.i22, %push.exit27 ], [ %call.i16, %push.exit21 ]
  %retval.0 = bitcast i8* %retval.0.in to %struct.node*
  ret %struct.node* %retval.0
}

; Function Attrs: nounwind uwtable
define %struct.node* @insert(%struct.node* %head, i32 %data) #2 {
entry:
  %cmp.i = icmp eq %struct.node* %head, null
...
; Function Attrs: nounwind uwtable
define %struct.node* @sort_by_insert(%struct.node* %head) #2 {
entry:
...
; Function Attrs: nounwind uwtable
define void @display(%struct.node* readonly %head) #2 {
entry:
  %cmp = icmp eq %struct.node* %head, null
...
; Function Attrs: nounwind readnone uwtable
define void @init(%struct.node* nocapture %head) #0 {
entry:
  ret void
}
